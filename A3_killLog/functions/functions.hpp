class cfgFunctions
{
  class ELDB
  {
    ...
    class functions
    {
      ...
      class getIdentities { 
        Description = "Gets the steamUID, name, side of killed & killer."; 
        file = "A3_killLog\functions\fn_getIdentities.sqf";
        };
      class getLocations { 
      ...
      class getSenario { 
        Description = "Get array of the map, mission, server info.";
        file = "A3_killLog\functions\fn_getSenario.sqf"; 
        }; 
      class init { 
        preInit = 1; 
